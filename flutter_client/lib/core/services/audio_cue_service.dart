...
class AudioCueService {
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      _isInitialized = true;
      _logger.info('AudioCueService: Custom native chimes preloaded into memory');
    } catch (e) {
      _logger.warning('AudioCueService: Failed to preload chimes ($e). System sounds fallback will be used.');
    }
  }
  ...
  void playStartCue() {
    if (_isInitialized && _startSoundPtr != null) {
      ...
      PlaySound(TEXT('SystemAsterisk'), 0, SND_ALIAS | SND_ASYNC | SND_NODEFAULT);
    }
  }
  ...
  void playStopCue() {
    if (_isInitialized && _stopSoundPtr != null) {
      ...
      PlaySound(TEXT('SystemDefault'), 0, SND_ALIAS | SND_ASYNC | SND_NODEFAULT);
    }
  }
